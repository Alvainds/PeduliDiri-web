...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.3&nocache=3790286586ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pedulidiri&table=users">`db_pedulidiri`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pedulidiri&table=travellogs">`db_pedulidiri`.`travellogs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pedulidiri&table=provinces">`db_pedulidiri`.`provinces`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pedulidiri&table=districts">`db_pedulidiri`.`districts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pedulidiri&table=subdistricts">`db_pedulidiri`.`subdistricts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pedulidiri&table=cities">`db_pedulidiri`.`cities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pedulidiri&table=locations">`db_pedulidiri`.`locations`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="575a463a7b2d2f443b5e7e2326293d49">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="db_pedulidiri" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="travellogs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `travellogs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `travellogs`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="locations">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `locations`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="locations">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `locations`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="cities">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cities`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="districts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `districts`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="provinces">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `provinces`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="subdistricts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `subdistricts`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_pedulidiri" targettable="subdistricts">
                            <div class="action_content">
